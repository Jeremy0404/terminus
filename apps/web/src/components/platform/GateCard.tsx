...
import type { GateDto, RunDto, TaskSummaryDto } from '@terminus/contracts';
  ...
  if (gate === 'merge') {
    return (
      <div className="action-card">
        ...
        <div className="row">
          <button type="button" className="btn primary" disabled={busy} onClick={() => void run(() => api.act(task.id, 'merge'))}>{t('gate.merge.action')}</button>
        </div>
